...
public class PositionCommand {
    ...
    public void changePosition(List<Entity> entities, String operation, Vector vector){
    ...
    public void changePosition(List<Entity> entities, String operation, String axis, double value){
